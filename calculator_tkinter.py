...
if True:
    ...
    button10 = Button(gui, text=' + ', fg='black', bg='red',
    ...
    button12 = Button(gui, text=' * ', fg='black', bg='red',
                    command=lambda: press("*"), height=1, width=7)
    button12.grid(row=4, column=3)

    button13 = Button(gui, text=' / ', fg='black', bg='red',
                    command=lambda: press("/"), height=1, width=7)
    button13.grid(row=5, column=3)

    button14 = Button(gui, text=' = ', fg='black', bg='red',
                    command=equalpress, height=1, width=7)
    button14.grid(row=5, column=2)

    button15 = Button(gui, text='Clear', fg='black', bg='red',
                    command=clear, height=1, width=7)
    button15.grid(row=5, column=1)

    button16 = Button(gui, text='.', fg='black', bg='red',
                    command=lambda: press('.'), height=1, width=7)
